...
|------|-----------|---------|
| Chain_Coil | Frozen in walls/ceiling, Antenora and Giudecca | Atmosphere — chains of betrayal, encased in ice |
| Table_Large | Ptolomea banquet table, frost-covered | Narrative — the betrayed feast |
| Chair_1 | Ptolomea, around table, frost-covered | Frozen guests at the table |
| Cage_Small | Caina, embedded in ice floor | Betrayers imprisoned in ice |
| Barrel | Ptolomea, frost-covered | Frozen provisions |
| Sword_Bronze | Caina, frozen in ice pillars | Weapons of betrayal, inaccessible |
| Shield_Wooden | Antenora, frost-covered on walls | Fortress defense, useless and frozen |
| Banner_1 | Antenora, frost-stiff on walls | Frozen national banners (betrayers of country) |
| Lantern_Wall | Glacial Stairs, unlit, frost-covered | Lanterns that provide NO light — dead |
| Chalice | Ptolomea table | The poisoned cup of betrayal |
| Book_7 | Judas Trap (secret) | Frozen codex of traitors |
...
| Room | Props |
|------|-------|
| Glacial Stairs | 4× Lantern_Wall (wall, surfaceAnchor: E/W alternating, offsetY: 1.5, UNLIT — frost-covered, dead), 2× Chain_Coil (ceiling, frozen, landings 2 and 4), ice stalactites (structural, ceiling) |
| Caina | 6× ice pillars (structural, 1×1 cell, full height, Ice003 material), 3× Cage_Small (embedded in floor ice, frozen betrayers), 2× Sword_Bronze (frozen into pillar surfaces, surfaceAnchor: pillar face, offsetY: 1.0) |
| Antenora | 4× Banner_1 (wall, surfaceAnchor: N/S alternating, offsetY: 2.0, frozen stiff), 3× Shield_Wooden (wall, surfaceAnchor: E, offsetY: 1.2, frost-covered), 2× Chain_Coil (ceiling, frozen, at corridor intersections) |
| Ptolomea | 1× Table_Large (center, frost-covered, set for feast), 6× Chair_1 (around table, frost-covered, some knocked over), 2× Chalice (on table, frozen contents), 1× Barrel (SE corner, frost-covered), 2× SmallBottle (on table, frozen) |
| Giudecca | Frozen waterfall (structural, back/south wall, 8 cells wide, full height), 4× Chain_Coil (ceiling, hanging over void sections), ice stalactites (structural, ceiling, fall as hazards) |
| Judas Trap | 1× Book_7 (floor, frost-covered codex), 1× Cage_Small (floor, containing frozen figure), 2× Coin_Pile (floor, frost-covered, worthless) |
| Cocytus Bridge | NONE. Empty ice. Void below. Wind only. |
| Azazel's Frozen Throne | Ice formation (structural, center, Azazel frozen within), cracked ice floor (structural, fragmenting in phases), 4× Chain_Coil (ceiling, massive, marking arena quadrants, frozen) |
...
- **3D elements:** Ceiling stalactites hang from above (1.5-2 cell height). Unlit Lantern_Wall props on alternating walls mark each landing. Chain_Coil frozen to ceiling at landings 2 and 4. The vertical descent creates a strong sense of going deeper.
...
- **3D elements:** Ice pillars (6, arranged in 2 rows of 3, staggered). Cage_Small props embedded in ice floor (decorative, frozen betrayers below). Sword_Bronze frozen into pillar surfaces — inaccessible, narrative.
...
- **3D elements:** Corridors are 3 wide × 2.5 tall — claustrophobic. Frozen Banner_1 props hang stiff from walls (surfaceAnchor: N/S, offsetY: 2.0). Shield_Wooden props on east wall (surfaceAnchor: E, offsetY: 1.2). Chain_Coil frozen to ceiling at corridor intersections. The fortress feel is ice-encased military architecture.
...
```
  ...
  │   ╔══════════════════╗             │
  │   ║  🍷 TABLE 🍷    ║ ♦ammo      │  ← Table_Large with frozen feast
...
- **3D elements:** Table_Large center (4×2 cells, 0.5 cell height). 6 Chair_1 props around table (some knocked, some upright). Chalice × 2 on table. SmallBottle × 2 on table. Barrel in SE corner (provides minimal cover). Ceiling at 1.5 cells — player cannot jump. Frost drips from ceiling.
...
- **3D elements:** Frozen waterfall (structural, south wall, 8 cells wide, full height — animated ice flow texture). Ice pillars (6 total, 2 rows of 3). Ice stalactites on ceiling (fall as hazards during waves). Floor sections that crack and fall — animated fracture lines appear 3 seconds before collapse (warning). Void below is visible through cracks — deep indigo glow.
...
- **Mechanic:** Ironic betrayal theme. The Book_7 on the floor is a codex listing names — "The traitors who built this place, and the traitor who reads this." The Cage_Small contains a frozen figure — a goat. A previous scapegoat who made it this far and was trapped. The generous pickups are genuine — the game does not betray the player who finds this room. But the narrative does: *you are not the first.*
- **3D elements:** Low-ceilinged (1.5 cells). Coin_Pile props frost-covered, partially buried in snow. Book_7 on floor (0 height), frost-covered. Cage_Small at 0 height, ice encrusting the bars.
...
- **3D elements:** Central ice formation (4×4 cells, 3 cells tall initially, fractures into 8 destructible sections). Floor fragments into 12-15 floating platforms (3x3 to 4x4 cells, 1-cell max gaps, walkable without jumping). Chain_Coil × 4 hanging from ceiling at arena quadrant boundaries (massive, decorative, frozen). Overhead light shaft (spotlight, `#ccddff`, narrow cone illuminating center). Void below with deep indigo glow. No walls visible — room edges fade to darkness. The sense of infinite frozen space.
...
2. **Caina — frozen knights:** Blue goatKnights stand motionless in the ice. As you approach, the ice cracks and they break free. They were betrayers of family — frozen mid-stride, mid-plea, mid-lie. Cage_Small props in the floor hold smaller frozen figures. Sword_Bronze frozen into pillars — weapons of betrayal, forever inaccessible.
...
4. **Ptolomea — the frozen feast:** A banquet table set for guests who will never eat. Chalices raised in toasts that will never be drunk. The enemies were guests at this table — or hosts who poisoned it. They thaw and attack. The hospitality was always a lie.
...
15. At least 4 Fantasy Props visible as GLB instances in scene
